...
public:
     ...
     * Tell if playing.
     */
    bool isPlaying() const { return state == State::PLAY; }
...
private:
    ...
    public:
        ...
        bool isSilence() const { return silence; }

        void changeTempo(int newTempo) { timeUnit = (60 * 1000 * 4 / newTempo / 32); }
         ...
         */
        void resetRemainingNoteDuration() { remainingNoteTime = 0; }

        /**
         * Get the remaining duration of the latest "saved" note.
         */
        unsigned short getRemainingNoteDuration() const { return remainingNoteTime; }
