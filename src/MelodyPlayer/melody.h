...
public:
    ...
    Melody(String title, unsigned short timeUnit, std::shared_ptr<std::vector<NoteDuration>> notes,
     ...
     */
    unsigned short getTimeUnit() const { return timeUnit; };
     ...
     */
    bool getAutomaticSilence() const { return automaticSilence; }

    /**
     * Return true if the melody is valid, false otherwise.
     */
    bool isValid() const { return notes != nullptr && (*notes).size() != 0; }
