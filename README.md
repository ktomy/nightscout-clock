...
| Rainbow big text | _(live animated view)_                                                                                                                        | Large glucose text with animated colors.                                                                                                                                                                                                                                                                                                                                                                    |
| Smiley           | _(live smiley view)_                                                                                                                          | A face that reflects glucose level: happy in range, sad when low, angry when high, and neutral for stale or missing data.                                                                                                                                                                                                                                                                                   |
...
- Multiple clock faces support
  ...
  - Battery and uptime
  - Rainbow big text
  - Smiley face, reflecting the glucose level with happy, sad, angry, or neutral expressions
